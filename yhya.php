...
$essential_files = [
    ...
    'data/proxies.txt' => '',
    'data/set.txt' => '',
    'data/namebot.txt' => 'Yhya Bot',
    'data/ok.txt' => '',
    'DEVER.json' => '{"source":"- ","developer":[]}', // ملف الإعدادات المهم
    'stting.txt' => 'on'
];
...
file_get_contents("https://api.telegram.org/bot$tk/setWebhook?url=".$_SERVER['HTTP_HOST'].$_SERVER['SCRIPT_NAME']);
...
$devchink = "Z_4_Z_D"; // يوزر قناتك بدون @
$ckl = "@$devchink";
// ========== المتغيرات المساعدة ==========
$DevUser = "@W_TT9";                              // يوزر المطور مع @
$Devch = "@W_TT9";                                 // نفس الحاجة
$Userbot = "$iidd";                               // ايدي البوت
...
function bot($method, $datas = []) {
    ...
    curl_setopt($ch, CURLOPT_POSTFIELDS, $datas); // إرسال البيانات كـ POST
    $res = curl_exec($ch);
    if (curl_error($ch)) {
